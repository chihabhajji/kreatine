...
type GuardedByMetadataType =
  RelationTupleWithReplacements<PossibleReplacements>;

const GUARDED_BY_METADATA_KEY = Symbol('GuardedByKey');

export const GuardedBy = (
  relationTuple: string | RelationTupleStringGenerator<PossibleReplacements>,
) => {
...
export const getGuardingRelationTuple = (
  ...
  return (
    reflector.get<GuardedByMetadataType, typeof GUARDED_BY_METADATA_KEY>(
